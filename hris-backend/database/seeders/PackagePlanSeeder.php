    ...
    public function run(): void
    {
        $plans = [
            ...
            [
                ...
                'features' => json_encode(["3 month access", "Up to 50 employees", "Head Office only with 2 branch officess"]),
                'price' => 1800000
            ],
            [
                'title' => 'Pro',
                'subtitle' => 'Advanced features for mid-sized enterprises',
                'features' => json_encode(["6 month access", "Up to 100 employees", "Head Office with 3 branch officess"]),
                'price' => 3600000
            ],
            [
                'title' => 'Enterprise',
                'subtitle' => 'Comprehensive solution for large organizations',
                'features' => json_encode(["12 month access", "Up to 1000 employees", "Head Office with 4 branch officess"]),
                'price' => 7200000
            ],
        ];
